 ...
 * contents of Wait3.xs. Do not edit this file, edit Wait3.xs instead.
 *
...
XS_EUPXS(XS_Proc__Wait3_wait3); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Proc__Wait3_wait3)
{
    dVAR; dXSARGS;
    if (items != 1)
...
extern "C"
#endif
XS_EXTERNAL(boot_Proc__Wait3); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Proc__Wait3)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("Proc::Wait3::wait3", XS_Proc__Wait3_wait3);
#if PERL_VERSION_LE(5, 21, 5)
