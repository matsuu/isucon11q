...
XS_EUPXS(XS_Cpanel__JSON__XS_CLONE); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_CLONE)
{
    dVAR; dXSARGS;
...
XS_EUPXS(XS_Cpanel__JSON__XS_END); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_END)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
XS_EUPXS(XS_Cpanel__JSON__XS_new); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_new)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_Cpanel__JSON__XS_ascii); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_ascii)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items < 1 || items > 2)
	...
	if (!(
           SvROK (ST(0))
           && SvOBJECT (SvRV (ST(0)))
           && (SvSTASH (SvRV (ST(0))) == JSON_STASH || sv_derived_from (ST(0), "Cpanel::JSON::XS"))
        )) {
          if (SvPOK (ST(0)))
...
XS_EUPXS(XS_Cpanel__JSON__XS_get_ascii); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_get_ascii)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items != 1)
...
XS_EUPXS(XS_Cpanel__JSON__XS_indent_length); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_indent_length)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "self, val= INDENT_STEP");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	JSON *	self;
...
XS_EUPXS(XS_Cpanel__JSON__XS_get_indent_length); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_get_indent_length)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Cpanel__JSON__XS_max_depth); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_max_depth)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "self, max_depth= 0x80000000UL");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	JSON *	self;
...
;
	...
	if (items < 2)
	    max_depth = 0x80000000UL;
	else {
	    max_depth = (unsigned long)SvUV(ST(1))
;
	}
#line 4725 "XS.xs"
...
XS_EUPXS(XS_Cpanel__JSON__XS_get_max_depth); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_get_max_depth)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Cpanel__JSON__XS_max_size); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_max_size)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
...
XS_EUPXS(XS_Cpanel__JSON__XS_get_max_size); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_get_max_size)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Cpanel__JSON__XS_stringify_infnan); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_stringify_infnan)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "self, infnan_mode= 1");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	JSON *	self;
...
XS_EUPXS(XS_Cpanel__JSON__XS_get_stringify_infnan); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_get_stringify_infnan)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Cpanel__JSON__XS_sort_by); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_sort_by)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "self, cb= &PL_sv_yes");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	JSON *	self;
...
XS_EUPXS(XS_Cpanel__JSON__XS_filter_json_object); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_filter_json_object)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
...
XS_EUPXS(XS_Cpanel__JSON__XS_filter_json_single_key_object); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_filter_json_single_key_object)
{
    dVAR; dXSARGS;
    if (items < 2 || items > 3)
...
XS_EUPXS(XS_Cpanel__JSON__XS_encode); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_encode)
{
    dVAR; dXSARGS;
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "self, scalar, typesv= &PL_sv_undef");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	JSON *	self;
...
XS_EUPXS(XS_Cpanel__JSON__XS_decode); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_decode)
{
    dVAR; dXSARGS;
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "self, jsonstr, typesv= NULL");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	JSON *	self;
...
XS_EUPXS(XS_Cpanel__JSON__XS_decode_prefix); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_decode_prefix)
{
    dVAR; dXSARGS;
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "self, jsonstr, typesv= NULL");
...
XS_EUPXS(XS_Cpanel__JSON__XS_incr_parse); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_incr_parse)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
...
XS_EUPXS(XS_Cpanel__JSON__XS_incr_text); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_incr_text)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Cpanel__JSON__XS_incr_skip); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_incr_skip)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Cpanel__JSON__XS_incr_reset); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_incr_reset)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Cpanel__JSON__XS_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_DESTROY)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Cpanel__JSON__XS_encode_json); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_encode_json)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "scalar, typesv= &PL_sv_undef");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	scalar = ST(0)
...
XS_EUPXS(XS_Cpanel__JSON__XS_decode_json); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Cpanel__JSON__XS_decode_json)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items < 1 || items > 3)
       croak_xs_usage(cv,  "jsonstr, allow_nonref= NULL, typesv= NULL");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	jsonstr = ST(0)
...
extern "C"
#endif
XS_EXTERNAL(boot_Cpanel__JSON__XS); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Cpanel__JSON__XS)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#if XSubPPtmpAAAA
        newXS_deffile("Cpanel::JSON::XS::CLONE", XS_Cpanel__JSON__XS_CLONE);
#endif
        newXS_deffile("Cpanel::JSON::XS::END", XS_Cpanel__JSON__XS_END);
        newXS_deffile("Cpanel::JSON::XS::new", XS_Cpanel__JSON__XS_new);
        cv = newXS_deffile("Cpanel::JSON::XS::allow_barekey", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_BAREKEY;
        cv = newXS_deffile("Cpanel::JSON::XS::allow_bignum", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_BIGNUM;
        cv = newXS_deffile("Cpanel::JSON::XS::allow_blessed", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_BLESSED;
        cv = newXS_deffile("Cpanel::JSON::XS::allow_dupkeys", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_DUPKEYS;
        cv = newXS_deffile("Cpanel::JSON::XS::allow_nonref", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_NONREF;
        cv = newXS_deffile("Cpanel::JSON::XS::allow_singlequote", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_SQUOTE;
        cv = newXS_deffile("Cpanel::JSON::XS::allow_stringify", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_STRINGIFY;
        cv = newXS_deffile("Cpanel::JSON::XS::allow_tags", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_TAGS;
        cv = newXS_deffile("Cpanel::JSON::XS::allow_unknown", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ALLOW_UNKNOWN;
        cv = newXS_deffile("Cpanel::JSON::XS::ascii", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ASCII;
        cv = newXS_deffile("Cpanel::JSON::XS::binary", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_BINARY;
        cv = newXS_deffile("Cpanel::JSON::XS::canonical", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_CANONICAL;
        cv = newXS_deffile("Cpanel::JSON::XS::convert_blessed", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_CONV_BLESSED;
        cv = newXS_deffile("Cpanel::JSON::XS::escape_slash", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_ESCAPE_SLASH;
        cv = newXS_deffile("Cpanel::JSON::XS::indent", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_INDENT;
        cv = newXS_deffile("Cpanel::JSON::XS::latin1", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_LATIN1;
        cv = newXS_deffile("Cpanel::JSON::XS::pretty", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_PRETTY;
        cv = newXS_deffile("Cpanel::JSON::XS::relaxed", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = SET_RELAXED;
        cv = newXS_deffile("Cpanel::JSON::XS::require_types", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_REQUIRE_TYPES;
        cv = newXS_deffile("Cpanel::JSON::XS::shrink", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_SHRINK;
        cv = newXS_deffile("Cpanel::JSON::XS::space_after", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_SPACE_AFTER;
        cv = newXS_deffile("Cpanel::JSON::XS::space_before", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_SPACE_BEFORE;
        cv = newXS_deffile("Cpanel::JSON::XS::type_all_string", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_TYPE_ALL_STRING;
        cv = newXS_deffile("Cpanel::JSON::XS::unblessed_bool", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_UNBLESSED_BOOL;
        cv = newXS_deffile("Cpanel::JSON::XS::utf8", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_UTF8;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_barekey", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_BAREKEY;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_bignum", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_BIGNUM;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_blessed", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_BLESSED;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_dupkeys", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_DUPKEYS;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_nonref", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_NONREF;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_singlequote", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_SQUOTE;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_stringify", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_STRINGIFY;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_tags", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_TAGS;
        cv = newXS_deffile("Cpanel::JSON::XS::get_allow_unknown", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ALLOW_UNKNOWN;
        cv = newXS_deffile("Cpanel::JSON::XS::get_ascii", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ASCII;
        cv = newXS_deffile("Cpanel::JSON::XS::get_binary", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_BINARY;
        cv = newXS_deffile("Cpanel::JSON::XS::get_canonical", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_CANONICAL;
        cv = newXS_deffile("Cpanel::JSON::XS::get_convert_blessed", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_CONV_BLESSED;
        cv = newXS_deffile("Cpanel::JSON::XS::get_escape_slash", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_ESCAPE_SLASH;
        cv = newXS_deffile("Cpanel::JSON::XS::get_indent", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_INDENT;
        cv = newXS_deffile("Cpanel::JSON::XS::get_latin1", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_LATIN1;
        cv = newXS_deffile("Cpanel::JSON::XS::get_relaxed", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_RELAXED;
        cv = newXS_deffile("Cpanel::JSON::XS::get_require_types", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_REQUIRE_TYPES;
        cv = newXS_deffile("Cpanel::JSON::XS::get_shrink", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_SHRINK;
        cv = newXS_deffile("Cpanel::JSON::XS::get_space_after", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_SPACE_AFTER;
        cv = newXS_deffile("Cpanel::JSON::XS::get_space_before", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_SPACE_BEFORE;
        cv = newXS_deffile("Cpanel::JSON::XS::get_type_all_string", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_TYPE_ALL_STRING;
        cv = newXS_deffile("Cpanel::JSON::XS::get_unblessed_bool", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_UNBLESSED_BOOL;
        cv = newXS_deffile("Cpanel::JSON::XS::get_utf8", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_UTF8;
        newXS_deffile("Cpanel::JSON::XS::indent_length", XS_Cpanel__JSON__XS_indent_length);
        newXS_deffile("Cpanel::JSON::XS::get_indent_length", XS_Cpanel__JSON__XS_get_indent_length);
        newXS_deffile("Cpanel::JSON::XS::max_depth", XS_Cpanel__JSON__XS_max_depth);
        newXS_deffile("Cpanel::JSON::XS::get_max_depth", XS_Cpanel__JSON__XS_get_max_depth);
        newXS_deffile("Cpanel::JSON::XS::max_size", XS_Cpanel__JSON__XS_max_size);
        newXS_deffile("Cpanel::JSON::XS::get_max_size", XS_Cpanel__JSON__XS_get_max_size);
        newXS_deffile("Cpanel::JSON::XS::stringify_infnan", XS_Cpanel__JSON__XS_stringify_infnan);
        newXS_deffile("Cpanel::JSON::XS::get_stringify_infnan", XS_Cpanel__JSON__XS_get_stringify_infnan);
        newXS_deffile("Cpanel::JSON::XS::sort_by", XS_Cpanel__JSON__XS_sort_by);
        newXS_deffile("Cpanel::JSON::XS::filter_json_object", XS_Cpanel__JSON__XS_filter_json_object);
        newXS_deffile("Cpanel::JSON::XS::filter_json_single_key_object", XS_Cpanel__JSON__XS_filter_json_single_key_object);
        newXS_deffile("Cpanel::JSON::XS::encode", XS_Cpanel__JSON__XS_encode);
        newXS_deffile("Cpanel::JSON::XS::decode", XS_Cpanel__JSON__XS_decode);
        newXS_deffile("Cpanel::JSON::XS::decode_prefix", XS_Cpanel__JSON__XS_decode_prefix);
        newXS_deffile("Cpanel::JSON::XS::incr_parse", XS_Cpanel__JSON__XS_incr_parse);
#if XSubPPtmpAAAB
        cv = newXS_deffile("Cpanel::JSON::XS::incr_text", XS_Cpanel__JSON__XS_incr_text);
        apply_attrs_string("Cpanel::JSON::XS", cv, "lvalue", 0);
#endif
#if XSubPPtmpAAAC
        newXS_deffile("Cpanel::JSON::XS::incr_text", XS_Cpanel__JSON__XS_incr_text);
#endif
        newXS_deffile("Cpanel::JSON::XS::incr_skip", XS_Cpanel__JSON__XS_incr_skip);
        newXS_deffile("Cpanel::JSON::XS::incr_reset", XS_Cpanel__JSON__XS_incr_reset);
        newXS_deffile("Cpanel::JSON::XS::DESTROY", XS_Cpanel__JSON__XS_DESTROY);
        cv = newXSproto_portable("Cpanel::JSON::XS::_to_json", XS_Cpanel__JSON__XS_encode_json, file, "$;$");
        XSANY.any_i32 = 0;
        cv = newXSproto_portable("Cpanel::JSON::XS::encode_json", XS_Cpanel__JSON__XS_encode_json, file, "$;$");
        XSANY.any_i32 = F_UTF8;
        cv = newXSproto_portable("Cpanel::JSON::XS::_from_json", XS_Cpanel__JSON__XS_decode_json, file, "$;$$");
        XSANY.any_i32 = 0;
