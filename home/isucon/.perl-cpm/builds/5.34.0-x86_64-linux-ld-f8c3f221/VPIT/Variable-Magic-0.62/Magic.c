 ...
 * contents of Magic.xs. Do not edit this file, edit Magic.xs instead.
 *
...
XS_EUPXS(XS_Variable__Magic_CLONE); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Variable__Magic_CLONE)
{
    dVAR; dXSARGS;
...
XS_EUPXS(XS_Variable__Magic__wizard); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Variable__Magic__wizard)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
XS_EUPXS(XS_Variable__Magic_cast); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Variable__Magic_cast)
{
    dVAR; dXSARGS;
    if (items < 2)
       croak_xs_usage(cv,  "sv, wiz, ...");
    {
#line 2030 "Magic.xs"
...
XS_EUPXS(XS_Variable__Magic_getdata); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Variable__Magic_getdata)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "sv, wiz");
...
XS_EUPXS(XS_Variable__Magic_dispell); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Variable__Magic_dispell)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "sv, wiz");
...
extern "C"
#endif
XS_EXTERNAL(boot_Variable__Magic); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Variable__Magic)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#if XSubPPtmpAAAA
        newXS_deffile("Variable::Magic::CLONE", XS_Variable__Magic_CLONE);
#endif
        newXS_deffile("Variable::Magic::_wizard", XS_Variable__Magic__wizard);
        (void)newXSproto_portable("Variable::Magic::cast", XS_Variable__Magic_cast, file, "\\[$@%&*]$@");
        (void)newXSproto_portable("Variable::Magic::getdata", XS_Variable__Magic_getdata, file, "\\[$@%&*]$");
        (void)newXSproto_portable("Variable::Magic::dispell", XS_Variable__Magic_dispell, file, "\\[$@%&*]$");
